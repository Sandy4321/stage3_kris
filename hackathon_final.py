...
CMD = 0  # [0 - "stone", 1 - "scissos", 2 - "paper"]
...
break_flag = True
# Нейронная сеть
net = buildNetwork(64*3, 48, 12, 3, bias=True, hiddenclass=SigmoidLayer)
...
def lets_start():
    ...
    # Инициализация сети
    n = constructPerceptron('perc', [64*3, 48, 12, 3])  # Создаём перцептрон
    ...
    while True:  # Infinite loop
        ...
        if FSM_state == 0:  # Education
            # show image
            background_image = Tk.PhotoImage(file="description_stone.gif")
            background_label = Tk.Label(root, image=background_image)
            background_label.place(x=0, y=0, relwidth=1, relheight=1)
            root.wm_geometry("1000x650+20+40")
            root.title('Go read your brain')
            ...
            for i in range(5):
                # show image
                background_image = Tk.PhotoImage(file="image_stone.gif")
                background_label = Tk.Label(root, image=background_image)
                background_label.place(x=0, y=0, relwidth=1, relheight=1)
                root.wm_geometry("1000x650+20+40")
                root.title('Go read your brain')
                ...
                #
                #
                education.append((learnData, [1, 0, 0]))
                ...
                # show image
                background_image = Tk.PhotoImage(file="image_scissors.gif")
                background_label = Tk.Label(root, image=background_image)
                background_label.place(x=0, y=0, relwidth=1, relheight=1)
                root.wm_geometry("1000x650+20+40")
                root.title('Go read your brain')
                ...
                education.append((learnData, [0, 0, 0]))
                ...
                # show image
                background_image = Tk.PhotoImage(file="image_paper.gif")
                background_label = Tk.Label(root, image=background_image)
                background_label.place(x=0, y=0, relwidth=1, relheight=1)
                root.wm_geometry("1000x650+20+40")
                root.title('Go read your brain')
            ...
            # show image
            background_image = Tk.PhotoImage(file="description_scissors.gif")
            background_label = Tk.Label(root, image=background_image)
            background_label.place(x=0, y=0, relwidth=1, relheight=1)
            root.wm_geometry("1000x650+20+40")
            root.title('Go read your brain')
            ...
            for i in range(5):
                ...
                education.append((learnData, [0, 1, 0]))
            ...
            # show image
            background_image = Tk.PhotoImage(file="description_paper.gif")
            background_label = Tk.Label(root, image=background_image)
            background_label.place(x=0, y=0, relwidth=1, relheight=1)
            root.wm_geometry("1000x650+20+40")
            root.title('Go read your brain')
            ...
            for i in range(5):
                ...
                education.append((learnData, [0, 0, 1]))
            ...
            saveNetwork(net, '/home/pi/hackathon/stage3_kris/net.xml')
            ...
            # Активизируем сеть! На вход подаем список из 192 чисел - вектор входных признаков
            recognition = trained_net.activate(learnData)

            print recognition

            if (recognition[0] > recognition[1] and recognition[0] > recognition[2]):
                print "stone"
                write_pack_fifo_buf_3D("STONE")
            elif (recognition[1] > recognition[0] and recognition[1] > recognition[2]):
                print "scissors"
                write_pack_fifo_buf_3D("SCISSORS")
            else:
                print "paper"
                write_pack_fifo_buf_3D("PAPER")
